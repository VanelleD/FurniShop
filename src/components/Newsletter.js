...
const Newsletter = () => {
  ...
  return (
    <section className="section bg-newsletter min-h-[490px]">
      ...
      >
        <div
          className="w-full max-w-[558px] text-center 
        text-white lg:text-left"
        >
          <h2
            className="text-4xl font-semibold max-w-[350px]
          mx-auto lg:mx-0 mb-5 leading-normal"
          >
            {title}
          </h2>
          ...
          <div className="flex flex-col lg:flex-row gap-[22px]">
            ...
            placeholder:text-gray-400 text-gray-600 rounded-lg
            lg:flex-1"
              type="text"
            ...
            hover:bg-slate-900 px-7 rounded-lg font-medium
            text-xl transition"
            >
              {buttonText}
            </button>
